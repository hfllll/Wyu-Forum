    ...
    <div class="flex justify-between mt-6">
      ...
      <div>
        ...
        <button class="btn btn-ghost btn-sm" @click="handleCollect(props.post)">
          <svg v-if="props.post.isCollected" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 animate-animted animate__rubberBand" fill="white" viewBox="0 0 24 24" stroke="currentColor">
